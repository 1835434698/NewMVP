...
public class SnackbarManagerCus {

    private static WeakReference<SnackbarCus> sSnackbar = null;

    public static void show(SnackbarCus snackbarCus) {
        sSnackbar = new WeakReference<>(snackbarCus);
        snackbarCus.show();
    }

    public static void dismiss() {
        final SnackbarCus snackbarCus = sSnackbar == null ? null : sSnackbar.get();
        if (snackbarCus != null) {
            snackbarCus.dismiss();
            sSnackbar = null;
        }
    ...
    static SnackbarManagerCus getInstance() {
        if (sSnackbarManager == null) {
            sSnackbarManager = new SnackbarManagerCus();
        }
    ...
    public void show(int duration, Callback callback) {
        synchronized (mLock) {
            ...
            if (mCurrentSnackbar != null && cancelSnackbarLocked(mCurrentSnackbar,
                    SnackbarCus.Callback.DISMISS_EVENT_CONSECUTIVE)) {
    ...
    private void scheduleTimeoutLocked(SnackbarRecord r) {
        if (r.duration == SnackbarCus.LENGTH_INDEFINITE) {
        ...
        } else if (r.duration == SnackbarCus.LENGTH_SHORT) {
    ...
    void handleTimeout(SnackbarRecord record) {
        synchronized (mLock) {
            if (mCurrentSnackbar == record || mNextSnackbar == record) {
                cancelSnackbarLocked(record, SnackbarCus.Callback.DISMISS_EVENT_TIMEOUT);
            }
        }
    }
}
